...
namespace Crosire.Controlcenter.Setup
{
	public class frmSetup : Form
	{
		...
		private void frmSetup_Load(object sender, EventArgs e)
		{
			...
			{
				labelVersion.Text = Resources.error;
			}
			if (!noWindow)
			{
		...
		private void subReloadResources()
		{
			...
			btnBack.Text = Resources.button_back;
			btnNext.Text = Resources.button_next;
			btnCancel.Text = Resources.button_cancel;
			btnBrowse.Text = Resources.button_browse;
			labelVersionDescription.Text = Resources.version;
			labelEnterDatabase.Text = Resources.sentence_enterdatabase;
			labelEnterPath.Text = Resources.sentence_enterpath;
			labelHost.Text = Resources.host;
			labelUser.Text = Resources.user;
			labelPass.Text = Resources.password;
			checkRedis.Text = Resources.sentence_installredis;
			checkBeta.Text = Resources.sentence_installpatch;
			checkOwn.Text = Resources.button_own;
			groupOptions.Text = Resources.group_options;
			groupDatabase.Text = Resources.group_database;
			radioReconfig.Text = Resources.button_reconfigurate;
			if (wizUpdate)
			{
				radioInstall.Text = Resources.button_update;
			}
			else
			{
				radioInstall.Text = Resources.button_fresh;
			}
		}
		...
		private void subStart()
		{
			...
			if (!wizReconf)
			{
				if (!(labelVersion.Text != Resources.error) && !string.IsNullOrEmpty(labelVersion.Text))
				{
		...
		private void InitializeComponent()
		{
			...
			this.pictureBanner.Image = Crosire.Controlcenter.Setup.Properties.Resources.banner;
			...
			this.downloader.Encoding = (System.Text.Encoding)resources.GetObject("downloader.Encoding");
			this.downloader.Headers = (System.Net.WebHeaderCollection)resources.GetObject("downloader.Headers");
			this.downloader.QueryString = (System.Collections.Specialized.NameValueCollection)resources.GetObject("downloader.QueryString");
			...
			this.labelCopyright.Location = new System.Drawing.Point(7, 542);
			...
			this.groupDatabase.Anchor = System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right;
			...
			this.pictureLogo.BackgroundImage = Crosire.Controlcenter.Setup.Properties.Resources.logo;
			this.pictureLogo.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Zoom;
			this.pictureLogo.Location = new System.Drawing.Point(10, 492);
			this.pictureLogo.Name = "pictureLogo";
			this.pictureLogo.Size = new System.Drawing.Size(472, 44);
			this.pictureLogo.TabIndex = 28;
			this.pictureLogo.TabStop = false;
			this.pictureLogo.Click += new System.EventHandler(pictureLogo_Click);
			this.pictureLogo.MouseLeave += new System.EventHandler(pictureLogo_MouseLeave);
			this.pictureLogo.MouseHover += new System.EventHandler(pictureLogo_MouseHover);
			...
			this.lblSupporter.Location = new System.Drawing.Point(10, 471);
			...
			base.ClientSize = new System.Drawing.Size(492, 566);
