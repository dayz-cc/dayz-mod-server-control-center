...
namespace Loadout.My
{
	...
	internal sealed class MyProject
	{
		...
		internal sealed class MyForms
		{
			...
			// (get) Token: 0x0600000C RID: 12 RVA: 0x00002188 File Offset: 0x00000388
			// (set) Token: 0x0600000D RID: 13 RVA: 0x000021AC File Offset: 0x000003AC
		...
		internal sealed class MyWebServices
		{
			...
			// Token: 0x06000017 RID: 23 RVA: 0x0000239C File Offset: 0x0000059C
			[EditorBrowsable(EditorBrowsableState.Never)]
			[DebuggerHidden]
			internal new Type GetType()
			{
		...
		internal sealed class ThreadSafeObjectProvider<T> where T : new()
		{
			...
			// (get) Token: 0x0600001C RID: 28 RVA: 0x00002408 File Offset: 0x00000608
